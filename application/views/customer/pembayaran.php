			...
			<div class="card">
              ...
              <td><button class="btn btn-sm btn-success">Rp.<?= number_format($tr->harga * $jmlHari, 0, ',', '.'); ?>,-</button></td>
							...
							<tr>
								<td></td>
								<td></td>
								<td><a href="<?= base_url('customer/transaksi/cetak_invoice/' . $tr->id_sewa) ?>" class="btn btn-sm btn-secondary">Print Invoice</a></td>
							</tr>
			...
			<form action="<?= base_url('customer/transaksi/pembayaran_aksi') ?>" method="post" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="hidden" name="id_rental" value="<?= $tr->id_sewa ?>">
