									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="post-tags">
												...
												<?php
												if ($mb->status == "1") { ?>
													<a href="<?= base_url('customer/rental/tambah_rental/' . $mb->id_ruangan) ?>"> Sewa</a></li>
												<?php } else { ?>
													<a href="#" style="color: black;"> Tidak Tersedia</a></li>
												<?php } ?>

												<li><a href="<?= base_url('customer/data_mobil/detail_mobil/' . $mb->id_ruangan) ?>"> | Detail</a></li>
											</ul>
										</div>
									</div>
								</div>
