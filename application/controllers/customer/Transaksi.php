...
class Transaksi extends CI_Controller
{
	...
	public function index()
	{
		...
		// var_dump($customer);
		// die;
		$data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, ruangan mb, customer cs WHERE tr.id_ruangan=mb.id_ruangan AND tr.id_customer=cs.id_customer AND cs.id_customer='$customer' ORDER BY id_sewa DESC")->result();
	...
	public function pembayaran_aksi()
	{
		...
		$data = array('bukti_apr' => $bukti_pembayaran);
	...
	public function batal_transaksi($id)
	{
		...
		$where2 = array('id_ruangan' => $data->id_mobil);
		// var_dump($where2);
		// die;
