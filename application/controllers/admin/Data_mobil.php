...
class Data_mobil extends CI_Controller
{
	...
	public function tambah_mobil_aksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->rental_model->insert_data($data, 'ruangan');
	...
	public function update_mobil_aksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$kode_tipe    = $this->input->post('kode_tipe');
			$merek        = $this->input->post('nama_ruangan');
			...
			$this->rental_model->update_data('ruangan', $data, $where);
			$this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
	...
	public function delete_mobil($id)
	{
		...
		$this->rental_model->delete_data($where, 'ruangan');
		$this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
